...
KE = (I1.*t2)./2.0+(I2.*dq2.^2)./2.0+(I3.*dq3.^2)./2.0+(I4.*dq4.^2)./2.0+(I5.*dq5.^2)./2.0+(m1.*(t2.*t4.^2+t2.*t6.^2))./2.0+(m2.*(t8.^2+t10.^2))./2.0+(m3.*(t13.^2+t16.^2))./2.0+(m4.*(t18.^2+t20.^2))./2.0+(m5.*(t22.^2+t24.^2))./2.0;
if nargout > 1
