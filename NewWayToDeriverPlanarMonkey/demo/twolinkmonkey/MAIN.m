...
t0 = 0;
tF = 1.4;  %For now, force it to take exactly this much time.
x0 = [-pi/6;-2*pi/3-pi/6];   %[q1;q2];  %initial angles   %Stable equilibrium
xF = [pi/6;2*pi/3+pi/6];  %[q1;q2];  %final angles    %Inverted balance
