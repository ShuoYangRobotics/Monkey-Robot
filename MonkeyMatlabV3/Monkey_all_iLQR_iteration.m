function [new_x_list,new_u_list,J,lamb, sim_new_trajectory, converge] = Monkey_all_iLQR_iteration(x0, xT, new_u_list, new_x_list,  dt, step, Q, R, Qf, lamb, sim_new_trajectory, g, Ftip, Mlist, Glist, Slist)
    lamb_factor = 2.5;
    lamb_max = 10000;
    % store fx fu lx lu
...
%         V_xx = Q_xx - fb_K(:,:,i)'*Q_uu*fb_K(:,:,i);
    ...
    [update_x_list, new_J] = Monkey_all_complete_run(x0, xT, update_u_list, dt, step, Q, R, Qf, g, Ftip, Mlist, Glist, Slist);
